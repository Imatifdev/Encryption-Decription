...
class TextDecryptionApp extends StatefulWidget {
  const TextDecryptionApp({super.key});

  @override
  State<TextDecryptionApp> createState() => _TextDecryptionAppState();
}

class _TextDecryptionAppState extends State<TextDecryptionApp> {
